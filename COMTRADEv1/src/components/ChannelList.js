...
export function createChannelList(
  ...
  tableDiv.className =
    "w-full border border-gray-300 dark:border-gray-700 rounded-lg shadow-md bg-white dark:bg-gray-800 transition-colors duration-300";
  ...
  addRowBtn?.addEventListener("click", () => {
    ...
    table.addRow(newRow, true).then((row) => {
      ...
      row.getCell("name").edit(); // auto-focus on first editable cell
    });
  });
